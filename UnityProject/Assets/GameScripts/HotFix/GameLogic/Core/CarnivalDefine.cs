namespace GameLogic.Core
{
    ...
    public enum CarnivalConsumableAction
    {
        ...
        CreateRandomConsumables,
        DoubleMoneyCapped,
        AddRandomJokerEditionChance,
        AddJokerSellValueMoney,
        AddRandomJoker,
        DestroyRandomAndCreateEnhancedCards,
        AddSealSelected,
        AddRandomEditionSelected,
        AddRandomJokerAndClearMoney,
        ChangeWholeHandRandomSuit,
        UnifyHandRankAndReduceHandSize,
        AddRandomJokerEditionAndReduceHandSize,
        DestroyRandomCardsAndAddMoney,
        CopyRandomJokerAndDestroyOthers,
        AddJokerEditionAndDestroyOthers,
        CopySelectedCardToHand,
        UpgradeRandomHands,
        UnifyHandRank,
        ChangeSelectedSuit,
        AddMoney,
